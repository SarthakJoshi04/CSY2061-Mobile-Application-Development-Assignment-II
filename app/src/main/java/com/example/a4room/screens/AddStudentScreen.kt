...
@Composable
fun AddStudentScreen(navController: NavHostController, userViewModel: UserViewModel){
    ...
    LaunchedEffect(insertionStatus) {
        when (insertionStatus) {
            is UserViewModel.Result.Success -> {
                Toast.makeText(context, "The student has been added.", Toast.LENGTH_SHORT).show()
                // Reset the form
                fullName = ""
                dateOfBirth = ""
                userEmail = ""
    ...
    Column(
        ...
        verticalArrangement = Arrangement.Center
            ...
            Text(text = "Add Student", style = MaterialTheme.typography.headlineLarge)
